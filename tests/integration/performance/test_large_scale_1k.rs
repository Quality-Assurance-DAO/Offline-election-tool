//! Performance test: 1k candidates and 10k nominators
...
fn test_large_scale_1k_candidates_10k_nominators() {
    const CANDIDATE_COUNT: usize = 1_000;
    const NOMINATOR_COUNT: usize = 10_000;
    const TARGET_TIME_MS: u64 = 60_000; // 60 seconds
    ...
    metadata.insert("benchmark_name".to_string(), "large_scale_1k".to_string());
